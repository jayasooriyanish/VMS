...
{
    public partial class FormRegisterFromSearchToManager : Form
    {
        ...
        public FormRegisterFromSearchToManager()
        {
            InitializeComponent();
        }

        private void FormRegisterFromSearchToManager_Load(object sender, EventArgs e)
        {
